    ...
    .list(
      {
        ...
        region_id: region.id,
        fields:
          "*variants.calculated_price,+variants.inventory_quantity,+variants.manage_inventory,+variants.allow_backorder,+variants.inventory_items.inventory_levels,+categories",
        ...queryParams,
      },
      { next: { tags: ["products"] } }
    )
